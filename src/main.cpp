...
int main()
{
    ...
    while (window.isOpen()) {
        ...
        for (int i = 0; (long unsigned int)i < selection_list.size(); i++) {
            ...
            if (selection_list[i].rectangle.getGlobalBounds().contains(x_mouse, y_mouse) and (selection_list[i].select == false)) {
        ...
        if (NextSlide.rectangle.getGlobalBounds().contains(x_mouse, y_mouse) and (NextSlide.select == false)) {
            for (int i = 0; (long unsigned int)i < selection_list.size(); i++) {
                if (selection_list[i].select == true) {
